        ...
        for (let i in direcciones)
        {
            ...
            if(enPosicion)
            {
                ...
                if (!matrizDesorganiza[posBusca.fila][posBusca.columna].ocupado) //pregunta si esta vacio
                {
                    ...
                    let estiloimg = utils.accesoDOM(fila+"_"+columna).style;
                    let estiloespacio = utils.accesoDOM(posBusca.fila+"_"+posBusca.columna).style;

                    //estilos para la nueva posición 
                    utils.accesoDOM(posBusca.fila+"_"+posBusca.columna).style.width = estiloimg.width;
                    utils.accesoDOM(posBusca.fila+"_"+posBusca.columna).style.height = estiloimg.height;
                    utils.accesoDOM(posBusca.fila+"_"+posBusca.columna).style.display = estiloimg.display;
                    utils.accesoDOM(posBusca.fila+"_"+posBusca.columna).style.border = estiloimg.border;
                    utils.accesoDOM(posBusca.fila+"_"+posBusca.columna).style.backgroundPosition = estiloimg.backgroundPosition;
                    utils.accesoDOM(posBusca.fila+"_"+posBusca.columna).style.cursor = estiloimg.cursor;
                    utils.accesoDOM(posBusca.fila+"_"+posBusca.columna).style.boxShadow = estiloimg.boxShadow;

                    utils.accesoDOM(posBusca.fila+"_"+posBusca.columna).className = "fondo";
                    utils.accesoDOM(posBusca.fila+"_"+posBusca.columna).innerHTML = utils.accesoDOM(fila+"_"+columna).innerHTML;
                    ...
                    utils.accesoDOM(fila+"_"+columna).className = "";
                    utils.accesoDOM(fila+"_"+columna).innerHTML = "&nbsp;";
                }
            }
        }
    }
