window.onload = function()
{
    ...
    */
    ...
    var crearPlanetas = function(data)
	{
    ...
    var init = (function()
    {
        ...
        {
            planetas[i].objeto=crearPlanetas({tamano:50,imagen: "img/planetas/" + planetas[i].imagen+ ".jpg"});
    ...
    var puntoDeVista = function()
	{
        ...
        if(frustum.intersectsObject(cube))
        {
            ...
            {
                veCubo = true;
                responsiveVoice.speak("Estas viendo el planeta luna, ", "Spanish Female");
            }
        }
        else
        {
